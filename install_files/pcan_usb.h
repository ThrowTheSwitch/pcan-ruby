...
//
//   CAN_ResetClient(void) //  löscht die beiden Nachrichten queues des Clients 
//
...
#define CAN_ERR_ILLHW	       0x1400  // Hardware-Handle ist ungültig.
#define CAN_ERR_ILLNET         0x1800  // Receive-Queue ist leergelesen.
#define CAN_ERR_ILLCLIENT      0x1C00  // Client-Handle ist ungültig.
...
//////////////////////////////////////////////////////////////////////////////
//  CAN_ResetClient()
//  löscht die beiden Nachrichten queues des Clients ohne Controller durch 
